...
const initWasm = async () => {
    ...
    const wasmImports = {
        ...
        env: {
            ...
            __print: console_print,   // Add __print(char c) function.
            ...
            _Z6mallocm: len => wasmMalloc ? wasmMalloc(len) : 0,          // [LinkError: WebAssembly.instantiate(): Import #7 module="env" function="_Z6mallocm" error: function import requires a callable]
            _Z4freePv: addr => wasmFree ? wasmFree(addr) : 0,             // [LinkError: WebAssembly.instantiate(): Import #8 module="env" function="_Z4freePv" error: function import requires a callable]
        }
    }
    ...
    wasmMalloc = wasmInstance.exports.walloc
    wasmFree = wasmInstance.exports.wfree

    if (!wasmMalloc) throw new Error("malloc function not found")
    if (!wasmFree) throw new Error("free function not found")
