    ...
    for (int i = 0; i < token_count; i++) {
        ...
        if (type == TOKEN_KEYWORD) {
            ...
            { // Mapped instructions
                ...
                if (token.equals("P_100ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B0, 2); _line_push; } // P_100ms: "u8.readBit 2.0",
                if (token.equals("P_200ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B1, 2); _line_push; } // P_200ms: "u8.readBit 2.1",
                if (token.equals("P_300ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B2, 2); _line_push; } // P_300ms: "u8.readBit 2.2",
                if (token.equals("P_500ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B3, 2); _line_push; } // P_500ms: "u8.readBit 2.3",
                if (token.equals("P_1s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B4, 2); _line_push; } // P_1s: "u8.readBit 2.4",
                if (token.equals("P_2s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B5, 2); _line_push; } // P_2s: "u8.readBit 2.5",
                if (token.equals("P_5s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B6, 2); _line_push; } // P_5s: "u8.readBit 2.6",
                if (token.equals("P_10s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B7, 2); _line_push; } // P_10s: "u8.readBit 2.7",
                if (token.equals("P_30s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B0, 3); _line_push; } // P_30s: "u8.readBit 3.0",
                if (token.equals("P_1min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B1, 3); _line_push; } // P_1min: "u8.readBit 3.1",
                if (token.equals("P_2min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B2, 3); _line_push; } // P_2min: "u8.readBit 3.2",
                if (token.equals("P_5min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B3, 3); _line_push; } // P_5min: "u8.readBit 3.3",
                if (token.equals("P_10min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B4, 3); _line_push; } // P_10min: "u8.readBit 3.4",
                if (token.equals("P_15min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B5, 3); _line_push; } // P_10min: "u8.readBit 3.5",
                if (token.equals("P_30min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B6, 3); _line_push; } // P_30min: "u8.readBit 3.6",
                if (token.equals("P_1hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B7, 3); _line_push; } // P_1hr: "u8.readBit 3.7",
                if (token.equals("P_2hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B0, 4); _line_push; } // P_2hr: "u8.readBit 4.0",
                if (token.equals("P_3hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B1, 4); _line_push; } // P_3hr: "u8.readBit 4.1",
                if (token.equals("P_4hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B2, 4); _line_push; } // P_4hr: "u8.readBit 4.2",
                if (token.equals("P_5hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B3, 4); _line_push; } // P_5hr: "u8.readBit 4.3",
                if (token.equals("P_6hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B4, 4); _line_push; } // P_6hr: "u8.readBit 4.4",
                if (token.equals("P_12hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B5, 4); _line_push; } // P_12hr: "u8.readBit 4.5",
                if (token.equals("P_1day")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B6, 4); _line_push; } // P_1day: "u8.readBit 4.6",
                
                if (token.equals("S_100ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B0, 5); _line_push; } // P_100ms: "u8.readBit 2.0",
                if (token.equals("S_200ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B1, 5); _line_push; } // P_200ms: "u8.readBit 2.1",
                if (token.equals("S_300ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B2, 5); _line_push; } // P_300ms: "u8.readBit 2.2",
                if (token.equals("S_500ms")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B3, 5); _line_push; } // P_500ms: "u8.readBit 2.3",
                if (token.equals("S_1s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B4, 5); _line_push; } // P_1s: "u8.readBit 2.4",
                if (token.equals("S_2s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B5, 5); _line_push; } // P_2s: "u8.readBit 2.5",
                if (token.equals("S_5s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B6, 5); _line_push; } // P_5s: "u8.readBit 2.6",
                if (token.equals("S_10s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B7, 5); _line_push; } // P_10s: "u8.readBit 2.7",
                if (token.equals("S_30s")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B0, 6); _line_push; } // P_30s: "u8.readBit 3.0",
                if (token.equals("S_1min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B1, 6); _line_push; } // P_1min: "u8.readBit 3.1",
                if (token.equals("S_2min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B2, 6); _line_push; } // P_2min: "u8.readBit 3.2",
                if (token.equals("S_5min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B3, 6); _line_push; } // P_5min: "u8.readBit 3.3",
                if (token.equals("S_10min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B4, 6); _line_push; } // P_10min: "u8.readBit 3.4",
                if (token.equals("S_15min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B5, 6); _line_push; } // P_10min: "u8.readBit 3.5",
                if (token.equals("S_30min")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B6, 6); _line_push; } // P_30min: "u8.readBit 3.6",
                if (token.equals("S_1hr")) { line.size = InstructionCompiler::push_InstructionWithU8(bytecode, READ_X8_B7, 6); _line_push; } // P_1hr: "u8.readBit 3.7",
            }
                ...
                if (data_type) {
                    ...
                    if (type == type_u8) {
                        ...
                        if (mem_bit_task) {
                            ...
                            line.size = InstructionCompiler::push_InstructionWithU8(bytecode, mem_bit_task, value_int); _line_push;
                        }
                    }
                }
            }
